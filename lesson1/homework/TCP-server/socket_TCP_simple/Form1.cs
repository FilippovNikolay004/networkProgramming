...
namespace socket_TCP_simple {
    public partial class Form1 : Form {
        ...
        public Queue<(string client, string data, int totalTime)> orderQueue = new Queue<(string, string, int)>();
            ...
            await Task.Run(() => {
                try {
                    ...
                    while (true) {
                        ...
                        data = (count++) + " " + Encoding.Default.GetString(bytes, 0, bytesRec);
        ...
        private async void ProcessQueue() {
            ...
            while (orderQueue.Count > 0) {
                ...
                Thread.Sleep(order.totalTime * 1000);
